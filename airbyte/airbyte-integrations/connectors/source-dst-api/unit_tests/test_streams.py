...
import pytest
from source_dst_api.source import DstApiStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(DstApiStream, "path", "v0/example_endpoint")
    mocker.patch.object(DstApiStream, "primary_key", "test_primary_key")
    mocker.patch.object(DstApiStream, "__abstractmethods__", set())
